	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				ghost: "text-slate-400 hover:bg-accent dark:hover:bg-accent/50",
				link: "text-slate-400 hover:text-slate-500",
			},
			size: {
				default: "h-5 px-3 py-1 has-[>svg]:px-2",
				sm: "h-4 gap-1.5 rounded-md px-2 has-[>svg]:px-1.5",
				lg: "h-10 rounded-md px-6 has-[>svg]:px-4",
				icon: "size-9",
				link: "px-0 py-0.5 gap-0.5"
			},
		},
		defaultVariants: {
			variant: "default",
